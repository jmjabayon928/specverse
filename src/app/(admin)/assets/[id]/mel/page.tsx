    ...
    <div className="p-6 space-y-6">
      ...
      <div className="p-6 bg-gray-50 rounded-md border border-gray-200">
        ...
        <p className="text-sm text-gray-500 mb-4">
          Mechanical Equipment List (MEL) view for this asset will be available here.
        </p>
        <ul className="text-sm text-gray-600 list-disc list-inside space-y-1">
          <li>View MEL context for this asset</li>
          <li>Navigate to related equipment</li>
          <li>View equipment hierarchy</li>
        </ul>
      </div>
    </div>
  )
